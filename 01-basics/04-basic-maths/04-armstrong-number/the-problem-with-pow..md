...
**Result:** Your logic fails, and the code says .
...
* **Floating Point `pow()` (Slow):** The `pow(x, y)` function doesn't just multiply. It actually uses logarithms and exponents to solve for non-integer powers (like ). The formula looks something like this:
