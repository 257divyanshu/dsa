...
// 📍 expalanation:
// - We find the first decreasing element from the right (nums[i]), which is the position where the permutation can be increased.
// - We then swap it with the smallest element greater than it from the right, and reverse the suffix to make it the smallest possible permutation greater than the current one.
...
// 📍 we can use the next_permutation() STL function to solve the problem
