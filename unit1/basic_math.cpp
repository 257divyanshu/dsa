...
// another ways is to loop from 1 to sqrt(n), this will lead us to TC of O(sqrt(n)), in every iteration we will store the divisor and also it's partner divisor is the divisor and partner divisor aren't same
